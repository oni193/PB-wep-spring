...
<body>
    ...
    <div class="abc">
    여러분을 환영합니다.<br>
다양한 플레이 볼링을 즐겨보세요.<br>
회원으로 가입하시면 플레이 볼링 서비스를 보다 편리하게 이용할 수 있습니다.<br>
여러분이 제공한 콘텐츠를 소중히 다룰 것입니다.<br>
여러분의 개인정보를 소중히 보호합니다.<br>
타인의 권리를 존중해 주세요.<br>
플레이 볼링 서비스 이용과 관련하여 몇 가지 주의사항이 있습니다.<br>
플레이 볼링에서 제공하는 다양한 포인트를 요긴하게 활용해 보세요.<br>
부득이 서비스 이용을 제한할 경우 합리적인 절차를 준수합니다.<br>
플레이 볼링의 잘못은 K2가 책임집니다.<br>
일부 플레이 볼링 서비스에는 광고가 포함되어 있습니다.<br>
언제든지 플레이 볼링 서비스 이용계약을 해지하실 수 있습니다.<br>
