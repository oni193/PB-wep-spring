	...
	<div class="join_form">
		...
		<div class="join_information">
			...
			<form class="information" method="POST" action="/member/register">
				<div class="form_i">
					<label for="mem_id">아이디(ID)</label> <input type="text" id="mem_id"
				...
				<div class="form_i">
					<label for="mem_email">이메일</label> <input type="email"
						...
						placeholder="&ensp;&ensp;yours@example.com" name="mem_email">
					<!-- <div class="invalid-feedback">올바른 이메일을 입력하세요.</div> -->
				</div>
				<div class="form_i">
					<label for="mem_name">이름</label> <input type="text" id="mem_name"
						class="form-control" name="mem_name">
					<!-- <div class="invalid-feedback" style="width:100%;">이름를 적어주세요.</div> -->
				</div>
				<div class="form_i">
					<label for="mem_nickName">닉네임</label> <input type="text"
						class="form-control" id="mem_nickName" name="mem_nickName">
				</div>
				<div class="form_i">
					<label for="mem_age">나이</label> <input type="text"
						class="form-control" id="mem_age" placeholder="&ensp;&ensp;ex.29"
						name="mem_age">
				</div>
				<div class="form_i">
					<label for="mem_address">주소</label> <input type="text"
						name="mem_address" class="form-control">
				</div>
